package me.replet.lunar.modmenu;
...
import me.replet.lunar.mixins.gamestate.UIElementAccessor;
import net.fabricmc.loader.api.FabricLoader;
import net.fabricmc.loader.impl.lib.sat4j.core.Vec;

import static me.replet.lunar.Lunar.*;
        ...
        UIElement configButton = new UIElement(0.0F, -20.0F, 150.0F, 30.0F) {
            public void onClick() {
                ...
                if(((UIElementAccessor)(Object)this).getShown()){
                    var state = getConfigScreen(selectedID,previousState);
                    if(state != null)
        ...
        for(var mod : FabricLoader.getInstance().getAllMods()){
            ...
            UIElement element = new UIElement(0F, yStart, 350f, 28.0F) {
                public void onClick() {
                    ...
                    if(configScreenFactories.containsKey(mod.getMetadata().getId()))

                        configButton.show();
                    else {
                        if (delayedScreenFactoryProviders.stream().anyMatch(obj -> obj.containsKey(mod.getMetadata().getId())))
                            configButton.show();
                        else
                            configButton.hide();
                    }}
